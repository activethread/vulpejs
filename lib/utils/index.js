...
exports.to = {
  ...
  text: function(value) {
    var string = [];
    if (value && typeof value === 'object' && value.join === undefined) {
      string.push('{');
      for (var property in value) {
        string.push(property, ': ', exports.to.text(value[property]), ',');
      }
      string.push('}');
    } else if (value && typeof value === 'object' && value.join !== undefined) {
      string.push('[');
      for (var property in value) {
        string.push(exports.to.text(value[property]), ',');
      }
      string.push(']');

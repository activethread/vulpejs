...
/* Services */
var app = angular.module('app.services', ['ui.bootstrap', 'ui.router', 'dialogs', 'i18n', 'ngCookies', 'ngResource']);
 ...
 */
app.factory('VulpeJS', ['$rootScope', '$parse', '$http', '$authenticator', '$messages', '$dialogs', '$timeout', '$interval', 'i18n', '$store', '$cookieStore', '$cookies', '$sce', '$window', '$filter', '$resource', function($rootScope, $parse, $http, $authenticator, $messages, $dialogs, $timeout, $interval, i18n, $store, $cookieStore, $cookies, $sce, $window, $filter, $resource) {

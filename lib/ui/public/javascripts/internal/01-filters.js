...
/* Filters */
angular.module('app.filters', ['i18n']).filter('startFrom', function() {
  return function(input, start) {
    start = +start;
    return input.slice(start);
  };
}).filter('money', ['$filter', '$locale', function(filter, locale) {
...
}).filter('booleanToString', ['i18n', function(i18n) {

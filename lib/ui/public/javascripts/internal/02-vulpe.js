...
var vulpe = {
  ng: {
    ...
    modules: ['app.controllers', 'textAngular', 'minicolors', 'toggle-switch', 'flow', 'blueimp.fileupload', 'ui.tree', 'vcRecaptcha', 'isteven-multi-select', 'angularjs-dropdown-multiselect', 'ui-rangeSlider', 'dndLists', 'chart.js', 'angular.morris-chart'],
    ...
    controller: function(options) {
      if (options.modules) {
        vulpe.ng.modules.push(options.modules);
      }
      return vulpe.ng.app.controller(options.name + 'Controller', ['$rootScope', '$scope', 'VulpeJS',
  ...
  utils: {
    removeDiacritics: function(str) {
      return str.replace(/[^\u0000-\u007E]/g, function(a) {
        return vulpe.utils.diacriticsMap[a] || a;
      });
    },
    regex: {
    ...
    time: {
      ...
      clock: function(options) {
        ...
        setTimeout(function() {
          vulpe.utils.time.clock(options);
        }, 1000);
      }
    },
    date: {
...
vulpe.ng.app = angular.module('app', vulpe.ng.modules);

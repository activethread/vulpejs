...
var vulpe = {
  ng: {
    ...
    modules: ['app.controllers', 'textAngular', 'minicolors', 'toggle-switch', 'flow', 'blueimp.fileupload', 'ui.modules.tree', 'vcRecaptcha', 'isteven-multi-select', 'angularjs-dropdown-multiselect', 'ui-rangeSlider', 'dndLists', 'chart.js', 'angular.morris-chart'],

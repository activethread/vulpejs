...
/* Controllers */
angular.module('app.controllers', ['app.directives', 'app.filters', 'app.services', 'angular-loading-bar', 'ui.utils', 'ui.utils.masks', 'timer', 'angularUtils.directives.dirPagination', 'mgcrea.ngStrap'])

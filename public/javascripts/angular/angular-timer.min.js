...
var timerModule = angular.module("timer", []).directive("timer", ["$compile", function(a) {
  return {
    ...
    controller: ["$scope", "$element", "$attrs", "$timeout", "I18nService", "$interpolate", function(b, c, d, e, f, g) {
      function h() {
      ...
      }), b.autoStart = d.autoStart || d.autostart, b.language = b.language || "en", b.$watch("language", function() {
        j.init(b.language)
      });
      var j = new f;
      j.init(b.language), c.append(0 === c.html().trim().length ? a("<span>" + g.startSymbol() + "millis" + g.endSymbol() + "</span>")(b) : a(c.contents())(b)), b.startTime = null, b.endTime = null, b.timeoutId = null, b.countdown = b.countdownattr && parseInt(b.countdownattr, 10) >= 0 ? parseInt(b.countdownattr, 10) : void 0, b.isRunning = !1, b.$on("timer-start", function() {
        b.start()
        ...
        b.startTime = b.startTimeAttr ? moment(b.startTimeAttr) : moment(), b.endTime = b.endTimeAttr ? moment(b.endTimeAttr) : null, b.countdown || (b.countdown = b.countdownattr && parseInt(b.countdownattr, 10) > 0 ? parseInt(b.countdownattr, 10) : void 0), h(), k(), b.isRunning = !0
      }, b.resume = c[0].resume = function() {
        h(), b.countdownattr && (b.countdown += 1), b.startTime = moment().diff(moment(b.stoppedTime).diff(moment(b.startTime))), k(), b.isRunning = !0
        ...
        b.stoppedTime = moment(), h(), b.timeoutId = null, b.isRunning = !1
      }, b.reset = c[0].reset = function() {
        b.startTime = b.startTimeAttr ? moment(b.startTimeAttr) : moment(), b.endTime = b.endTimeAttr ? moment(b.endTimeAttr) : null, b.countdown = b.countdownattr && parseInt(b.countdownattr, 10) > 0 ? parseInt(b.countdownattr, 10) : void 0, h(), k(), b.isRunning = !1, b.clear()
        ...
        b.isRunning || b.clear(), b.countdown = c, b.millis = 1e3 * c, i()
      })) : b.millis = 0, i();
      var k = function l() {
        b.millis = moment().diff(b.startTime);
        var a = b.millis % 1e3;
        return b.endTimeAttr && (b.millis = moment(b.endTime).diff(moment()), a = b.interval - b.millis % 1e3), b.countdownattr && (b.millis = 1e3 * b.countdown), b.millis < 0 ? (b.stop(), b.millis = 0, i(), void(b.finishCallback && b.$eval(b.finishCallback))) : (i(), b.timeoutId = setTimeout(function() {
          l(), b.$digest()
...
app.factory("I18nService", function() {
  var a = function() {};
  return a.prototype.language = "en", a.prototype.timeHumanizer = {}, a.prototype.init = function(a) {
    this.language = a, moment.locale(this.language), this.timeHumanizer = humanizeDuration.humanizer({
